            ...
            <div class="mint-msgbox" v-show="value">
                ...
                <div class="mint-msgbox-content" v-if="message !== ''">
                    ...
                    <div class="mint-msgbox-input" v-show="showInput">
                        <input v-model.trim="inputValue" :placeholder="inputPlaceholder" ref="input">
                ...
                <div class="mint-msgbox-btns">
                    ...
                    <button :class="[ confirmButtonClasses ]" v-show="showConfirmButton"
                            @click="handleAction('confirm')">{{ confirmButtonText }}
                    </button>
                </div>
            </div>
        </transition>
...
<style>
    ...
    .mint-msgbox .inline-p {
        font-size: 36px; /*px*/
        color: #222;
        margin: 59px 15px 49px;
        line-height: 1.5;
        font-weight: 400;
    }

    .mint-msgbox .mint-msgbox-input input.invalid {
        border-color: #FF4949;
    }

    .mint-msgbox .mint-msgbox-input input.invalid:focus {
        border-color: #FF4949;
    }

    .mint-msgbox .mint-msgbox-errormsg {
        color: red;
        font-size: 24px; /*px*/
        min-height: 36px;
        margin-top: 4px;
...
<style src="./pop/popup.css"></style>

<script type="text/babel">
    let CONFIRM_TEXT = '确定';
    let CANCEL_TEXT = '取消';

    import Popup from './pop/index.js';
